...
* Gravity Linear Accerelation
    ...
    + 60 tGravityAcc-iqr()-X, 61 tGravityAcc-iqr()-Y, 62 tGravityAcc-iqr()-Z
...
* Body Linear Accerelation (Fast Fourier Transform)
    ...
    + 299 fBodyAcc-skewness()-Y, 300 fBodyAcc-kurtosis()-Y
